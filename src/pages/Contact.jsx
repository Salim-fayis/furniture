...
const Contact = () => {
  ...
  // 🔥 No backend — simulate instant success
  const handleSubmit = async (e) => {
    e.preventDefault();
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-amber-50 to-white">
      ...
      <div className="bg-gradient-to-r from-amber-800 to-amber-900 text-white py-20">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <p className="text-xl text-amber-100 max-w-3xl">
            {language === "en"
              ? "Get in touch with our team for inquiries, support, or showroom visits."
              : "تواصل مع فريقنا للاستفسارات أو الدعم أو زيارات صالة العرض."}
          </p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-20 grid grid-cols-1 lg:grid-cols-3 gap-12">
        ...
        <div className="space-y-6">
          {contactInfo.map((info, i) => {
            const Icon = info.icon;
            const content = (
              <Card className="border-2 border-amber-200 hover:border-amber-500 transition-all duration-300 hover:shadow-xl cursor-pointer group">
                <CardContent className="p-6">
                  <div className="flex items-start gap-4">
                    <div className="w-12 h-12 bg-gradient-to-br from-amber-500 to-amber-700 rounded-xl flex items-center justify-center shadow-md group-hover:scale-110 transition-transform duration-300">
                      <Icon className="w-6 h-6 text-white" />
                    </div>
                    <div>
            ...
            <CardContent className="p-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <Button
                  type="submit"
                  size="lg"
                  className="w-full bg-gradient-to-r from-amber-600 to-amber-700 hover:from-amber-700 hover:to-amber-800 text-white py-6 text-lg font-bold shadow-lg hover:shadow-xl transition-all"
                >
                  {language === "en" ? "Send Message" : "إرسال الرسالة"}
                </Button>
              </form>

              <p className="text-sm text-amber-700 text-center mt-8 pt-8 border-t-2 border-amber-200">
                {language === "en"
                  ? "We typically respond within 24 hours during business days."
                  : "عادة ما نرد خلال 24 ساعة في أيام العمل."}
              </p>
            </CardContent>
          </Card>
        </div>
      ...
      {/* CTA */}
      <section className="py-16 bg-gradient-to-r from-amber-800 to-amber-900 text-white text-center">
        <h2 className="text-3xl md:text-4xl font-bold mb-4">
          {language === "en" ? "Visit Our Showroom" : "قم بزيارة صالة العرض"}
        </h2>
        <p className="text-xl text-amber-100">
          {language === "en"
            ? "Explore our furniture collection and get expert advice."
            : "استكشف مجموعتنا واحصل على نصائح من خبرائنا."}
        </p>
      </section>
    </div>
  );
